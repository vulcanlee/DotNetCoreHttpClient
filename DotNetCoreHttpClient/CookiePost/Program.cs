...
namespace CookiePost
{
    class Program
    {
        ...
        {
            #region 使用 Post 方法，取得 Cookie，呼叫 Web API 的結果
            #region 呼叫 Web API 得到成功的結果 - 會得到後端回傳的 Cookie
            ...
            #region 呼叫 Web API 得到失敗的結果 - 這個帳號與密碼不正確
            ...
            #region 呼叫 Web API 且透過 Cookie 繼續存取其他受保護的 API
            ...
            #region 呼叫 Web API 得到失敗的結果 - 因為沒有傳送正確 Cookie 到後端，所以，無法存取其他受保護的 API
        ...
        /// <summary>
        /// 模擬使用者登入，若成功，可以取得 Cookie
        /// </summary>
        /// <param name="loginInformation">使用者登入資訊</param>
        /// <returns></returns>
        ...
        /// <summary>
        /// 使用通過身分驗證的 Cookie 內容，進而存取其他受保護的 API
        /// </summary>
        /// <param name="responseCookie">Cookie的內容</param>
        /// <returns></returns>
